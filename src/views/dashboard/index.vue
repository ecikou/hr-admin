    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <p>{{ $t("message.hello") }}</p>
          <div class="headImg">
            <img v-imgerror :src="$store.state.user.userInfo.staff" />
          </div>
          <div class="headInfoTip">
            <p class="firstChild">{{ name }}</p>
            <p class="lastChild">
              {{ name }}---{{ userInfo.company }}--{{ userInfo.departmentName }}
            </p>
          </div>
        </div>
        <div class="fr" />
...
import WorkCalebctdac from './components/WorkCalebctdac.vue'
export default {
  name: 'Dashboard',
  components: {
    WorkCalebctdac
